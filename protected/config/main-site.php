...
//				'ext.awegen',
			...
			'ipFilters'=>array('127.0.0.1','117.205.105.61','::1'),
		),
	...
	/*	'db'=>array(
		...
		'db'=>array(
			'connectionString' => 'mysql:host=localhost;dbname=radhanik_audiostore',
			'emulatePrepare' => true,
			'username' => 'radhanik_audio',
			'password' => 'Audiostore@123!',
			'charset' => 'utf8',
			'tablePrefix'=>'',
		),
