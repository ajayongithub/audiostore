...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('cassette-details-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<fieldset>
    <legend>
        <?php echo Yii::t('AweCrud.app', 'Manage') ?> <?php echo CassetteDetails::label(2) ?>    </legend>
